// Minimal stroke icons - lucide-ish
const Icon = ({ name, size = 16, stroke = 1.75, ...rest }) => {
  const paths = {
    ...
    compare: <><path d="M4 5h6v14H4z"/><path d="M14 5h6v14h-6z"/><path d="m2 12 2-2v4l-2-2Z" fill="currentColor"/><path d="m22 12-2-2v4l2-2Z" fill="currentColor"/></>,
